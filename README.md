...
[cuML benchmarks](https://docs.nvidia.com/cuml/latest/cuml-accel/benchmarks/) for
...
Run an existing Python script through the [`cuml.accel` module](https://docs.nvidia.com/cuml/latest/cuml-accel/):
...
documentation](https://docs.nvidia.com/cuml/latest/cuml-accel/compatibility/) for
current coverage and fallback conditions. Use the [logging and profiling
tools](https://docs.nvidia.com/cuml/latest/cuml-accel/logging-and-profiling/) to check
...
the [multi-GPU guide](https://docs.nvidia.com/cuml/latest/dask_multigpu_guide/) for
